...
export default function PortfolioPage() {
  ...
  const handleAddHolding = async (e) => {
    ...
    try {
      ...
      await addDoc(collection(db, "portfolios"), newHolding);
      //reset form
      setFormData({
        symbol: "",
        quantity: "",
  ...
  //not logged in state (must be logged in to view portfolio)
  if (!user) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-100">
        <div className="bg-white p-8 rounded-lg shadow-md text-center">
          <p className="text-xl text-gray-700 mb-4">Please sign in to view your portfolio</p>
